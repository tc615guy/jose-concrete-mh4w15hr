...
export default function Page() {
  ...
  const businessName = "Jose Concrete";
  const serviceType = "Other";
  const serviceDescription = "Concrete and Driveway Services";
  const serviceAreas = "Greater Atlanta Area";
  const phoneNumber = "999-999-9999";
  const email = "me@joseconcrete.com";
  const logo = "https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/logo-1761312555137-qvcq1b.png";
  const differentiation2 = "Reliable and Afffordable";
  const differentiation3 = "Warranty";
  const headerFooterColor = "#1f2937";
  const backgroundColor = "#ffffff";
  const accentColor = "#aba0a0";

  const portfolioPhotos: Array<{name: string; type: string; url: string}> = [{"name":"download (1).jpg","type":"image/jpeg","url":"https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/1761312504208-i04e6d.jpg"},{"name":"download (2).jpg","type":"image/jpeg","url":"https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/1761312504692-78dbr9.jpg"},{"name":"download (3).jpg","type":"image/jpeg","url":"https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/1761312504918-xrsjna.jpg"},{"name":"download (4).jpg","type":"image/jpeg","url":"https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/1761312505118-wv2fve.jpg"},{"name":"download (5).jpg","type":"image/jpeg","url":"https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/1761312505272-9fot2e.jpg"},{"name":"download (6).jpg","type":"image/jpeg","url":"https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/1761312505444-7adi5.jpg"},{"name":"download (7).jpg","type":"image/jpeg","url":"https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/1761312505628-905t3.jpg"},{"name":"download.jpg","type":"image/jpeg","url":"https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/1761312505815-j5a7f.jpg"}];
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://facebook.com/concrete" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </a>
                <a href="https://instagram.com/concrete" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://x.com/concrete" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
